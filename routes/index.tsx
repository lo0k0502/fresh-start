  ...
  return (
    <>
      ...
      <div
        ...
        class='bg-transparent w-full h-20 border-white absolute px-4 py-2 gap-2 flex items-center text-white'
      >
        <NASMenuIcon />
      ...
      <div class='bg-gradient-to-br from-blue-950 via-sky-800 to-blue-950 w-full h-full pt-28 px-8 text-white'>
